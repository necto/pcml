...
We tried to train the NN with the CNN features and the same configuration, and this time the BER is 13\%.
...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		\hline Class & $N_{c}$ & Airplane & Car & Horse & Other & BER \\ 
		\hline Airplane & 310 & 293 & 5 & 2 & 10 & 6 ($\pm$ )\% \\ 
		\hline Car & 349 & 12 & 325 & 4 & 8 & 7 ($\pm$ )\% \\ 
		\hline Horse & 311 & 4 & 0 & 286 & 21 & 8 ($\pm$ )\% \\ 
		\hline Other & 315 & 8 & 10 & 39 & 258 & 18 ($\pm$ )\% \\ 
		\hline 
	\end{tabular} 
